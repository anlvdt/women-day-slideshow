...
Nếu bạn thấy dự án hữu ích, hãy ủng hộ mình bằng một trong các cách sau:
...
|-----------|-------------|---------------|
| Vietcombank | `YOUR_ACCOUNT_NUMBER` | `YOUR_NAME` |
| Momo | `YOUR_PHONE` | `YOUR_NAME` |

### Mua sắm qua Shopee Affiliate

Ủng hộ mình bằng cách mua sắm qua các link Shopee bên dưới — bạn không mất thêm chi phí, mình nhận được một khoản hoa hồng nhỏ từ Shopee:
...
Hoặc dùng link tổng: **[Mua sắm trên Shopee](https://shope.ee/YOUR_GENERAL_AFFILIATE_LINK)**

### Ủng hộ khác

- Star repo trên GitHub
- Chia sẻ dự án cho bạn bè, đồng nghiệp
- Báo bug hoặc đề xuất tính năng mới qua [Issues](https://github.com/anlvdt/women-day-slideshow/issues)
- Đóng góp code qua [Pull Requests](https://github.com/anlvdt/women-day-slideshow/pulls)
